...
app.layout = html.Div([
    ...
    html.H1("Automobile sales statistics dashboard", style ={'textAlign':'middle', 'color' : '#503D36', 'font-size':24}),#May include style for title
...
#Plot 1 Automobile sales fluctuate over Recession Period (year wise)
        ...
        R_chart3 = dcc.Graph(figure = px.pie(exp_rec, values = 'Advertising_Expenditure',
         names = 'Vehicle_Type', title = 'Expenditure share by vehicles' ))
        
        # Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        recession_data1 = recession_data.copy()
        recession_data1['unemployment_rate'] = recession_data['unemployment_rate'].round(0)



        R_chart4 = dcc.Graph(figure = px.bar(recession_data1,x='unemployment_rate',
         y='Automobile_Sales',
        color='Vehicle_Type',
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        sum_mon = data.groupby("Month", sort=False)["Automobile_Sales"].sum().reset_index()
        Y_chart2 = dcc.Graph(figure = px.line(sum_mon, 
        x = "Month",
        y = "Automobile_Sales",
